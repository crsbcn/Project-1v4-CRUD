...
<h2>Money you have to get from people, <%= session.getAttribute("currentUser") %>!</h2>


<form action="/Proj1/api/todos" method="POST">
...
const populateTodosTable = () => {
	...
	xhr.open("GET", "http://localhost:8088/Proj1/api/todos");
	xhr.send();
}
